                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-11">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="./includes/ajax.php?action=save_post" method="post" id="manage-post" 
                                            ...
                                            <div class="row mx-lg-2">
                                             ...
                                             <div class="form-floating mb-5">
                                               ...
                                               <input class="form-control" id="first_name" name="first_name" type="text" placeholder="" value="<?php echo isset($meta['first_name']) ? $user->safe($meta['first_name']) : '';
                                             ...
                                             <div class="form-floating mb-5">
                                               ...
                                               placeholder="" value="<?php echo isset($meta['last_name']) ? $user->safe($meta['last_name']) : '';
                                          ...
                                          <div class="col-lg-7 mx-lg-3" id="hiddenInput" style="display: none;">
                                            ...
                                            <div class="form-group mx-lg-3 mb-3">
                                            	<label for="post" class="control-label">Description</label>
					                            <textarea type="text" id="post" name="post" class="form-control required"
					                             cols="30" rows="15">
					                           	<?php
				                          ...
				                          <center class="mt-3 mb-5"><button type="submit" class="btn btn-primary btn-block col-md-2 my-4 
				                          	px-5" onclick="validateForm()">Save</button></center>
                                        </form>
